...
#if defined(NDEBUG)
# error "PlatinumBar cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "PlatinumBar Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nHeight, int64_t nFees)
{
    int64_t nSubsidy = 0 * COIN;
 	...
 	else if (nHeight > 18000){nSubsidy = .01 * COIN;}
...
{
    RenameThread("platinumbar-loadblk");
